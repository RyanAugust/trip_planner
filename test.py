...
first = trip_timer.segment(segment_name='first',segment_start=datetime.now(), segment_time=timedelta(hours=2))
print('---passed---')
...
baldy.add_segment(segment_name='baldy ascent', 
				  ...
				  segment_end=datetime(year=2020, month=11, day=26, hour=6, minute=35))
